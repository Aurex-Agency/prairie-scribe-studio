...
export const Host = () => {
  return (
    <section id="host" className="bg-light relative py-24 md:py-36 overflow-hidden">
      <div className="container grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
        <div className="lg:col-span-5 lg:-mt-32 relative">
          <div className="relative shadow-leather">
            <img
              ...
              height={1400}
            />
            <div className="absolute inset-0 ring-1 ring-primary-dark/10" />
          </div>
          <p className="font-body italic text-sm text-muted-foreground mt-4 max-w-xs">
        ...
        <div className="lg:col-span-7 lg:pt-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="label text-sage">Chapter 05 — The host</span>
          </div>
          <h2 className="display text-4xl sm:text-6xl md:text-7xl text-primary-dark leading-[1]">
          ...
          <div className="mt-10 space-y-6 text-lg leading-relaxed text-foreground/80 max-w-2xl">
            <p>
          ...
          <div className="mt-10">
            <a href="#mission" className="inline-flex items-center gap-3 font-condensed uppercase tracking-[0.22em] text-sm text-clay-red border-b border-clay-red/40 hover:border-clay-red pb-1 transition-colors">
